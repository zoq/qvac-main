...
* [**Completion:**](/sdk/examples/ai-tasks/completion) LLM inference for text generation and chat via [`llama.cpp`](https://github.com/ggml-org/llama.cpp).
* [**Text embeddings:**](/sdk/examples/ai-tasks/text-embeddings) vector embedding generation for semantic search, clustering, and retrieval, via `llama.cpp`.
* [**Translation:**](/sdk/examples/ai-tasks/translation) text-to-text neural machine translation (NMT), via [Marian](https://marian-nmt.github.io) and [Bergamot](https://browser.mt).
* [**Transcription:**](/sdk/examples/ai-tasks/transcription) automatic speech recognition (ASR) for speech-to-text via [`whisper.cpp`](https://github.com/ggml-org/whisper.cpp) or [NVIDIA Parakeet](https://huggingface.co/nvidia/parakeet-tdt-0.6b-v2).
