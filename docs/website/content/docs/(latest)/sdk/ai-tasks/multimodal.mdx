...
[Completion](/sdk/ai-tasks/completion) supports multimodal prompts. Multimodal lets you attach media files to inputs for [`completion()`](/sdk/api/completion). You can include multiple attachments in the same request (e.g., to compare two images).
