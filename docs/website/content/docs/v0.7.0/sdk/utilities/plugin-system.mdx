...
| --- | --- | --- |
| LLM | `@qvac/sdk/llamacpp-completion/plugin` | [Completion](/v0.7.0/sdk/ai-tasks/completion); [multimodal](/v0.7.0/sdk/ai-tasks/multimodal); [RAG](/v0.7.0/sdk/ai-tasks/rag) |
| Embeddings | `@qvac/sdk/llamacpp-embedding/plugin` | [Text embeddings](/v0.7.0/sdk/ai-tasks/text-embeddings); [RAG](/v0.7.0/sdk/ai-tasks/rag) |
| ASR | `@qvac/sdk/whispercpp-transcription/plugin` | [Transcription](/v0.7.0/sdk/ai-tasks/transcription) |
| NMT | `@qvac/sdk/nmtcpp-translation/plugin` | [Translation](/v0.7.0/sdk/ai-tasks/translation) |
| TTS | `@qvac/sdk/onnx-tts/plugin` | [Text-to-Speech](/v0.7.0/sdk/ai-tasks/text-to-speech) |
| OCR | `@qvac/sdk/onnx-ocr/plugin` | [OCR](/v0.7.0/sdk/ai-tasks/ocr) |
...
<Step>
[In your `qvac.config.*`, add the built-in plugins you’ll need in your project](/v0.7.0/sdk/configuration). For example:
...
[When developing for mobile environment, use the Expo CLI to prebuild your project only with the selected plugins:](/v0.7.0/sdk/installation/#expo)
...
[In your `qvac.config.*`, add its `<package_name>/plugin` specifier alongside any built-in plugins](/v0.7.0/sdk/configuration). For example:
...
<Tab value="mobile" label="Expo">
[When developing for mobile environment, use the Expo CLI to prebuild your project with all listed plugins:](/v0.7.0/sdk/installation/#expo)
...
* [Each plugin maps to one QVAC addon](/v0.7.0/addons).
* [Write a custom plugin](/v0.7.0/sdk/utilities/write-custom-plugin).