...
[Bare module](https://bare.pears.com) that adds support for translation in QVAC using either [`nmt.cpp`](https://github.com/tetherto/qvac/tree/main/packages/qvac-lib-infer-nmtcpp) or [Bergamot](https://browser.mt) as the inference engine.
