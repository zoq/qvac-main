...
<Cards>
  <Card href="/v0.7.0/welcome" icon={<DoorOpen className="text-[var(--color-fd-primary)]" />} title="Welcome">
    Learn what QVAC is, why Tether built it, and what makes it different.
  </Card>
  <Card href="/v0.7.0/welcome" icon={<Telescope className="text-[var(--color-fd-primary)]" />} title="Our vision">
...
<Cards>
  <Card href="/v0.7.0/sdk" icon={<Compass className="text-[var(--color-fd-primary)]" />} title="Get started with QVAC SDK">
    Use the JS/TS SDK to build local and P2P AI applications and systems.
  </Card>
  <Card href="/v0.7.0/sdk/quickstart" icon={<Rocket className="text-[var(--color-fd-primary)]" />} title="Quickstart">
    Run your first example using the JS/TS SDK.
  </Card>
  <Card href="/v0.7.0/sdk/installation" icon={<Package className="text-[var(--color-fd-primary)]" />} title="Installation">
    Supported environments and how to install the SDK for each one: Node.js, Bare, and Expo.
  </Card>
  <Card href="/v0.7.0/sdk/api" icon={<BookA className="text-[var(--color-fd-primary)]" />} title="API reference">
...
<Cards>
  <Card href="/v0.7.0/flagship-apps" icon={<LayoutGrid className="text-[var(--color-fd-primary)]" />} title="Flagship applications">
    Desktop and mobile apps to empower users and showcase QVAC capabilities.
  </Card>

  <Card href="/v0.7.0/addons" icon={<Blocks className="text-[var(--color-fd-primary)]" />} title="Addons">
...
<Cards>
  <Card href="/v0.7.0/sdk/tutorials/electron" icon={<SiElectron className="text-[var(--color-fd-primary)]" />} title="Build an Electron app">
    Hands-on tutorial on using QVAC SDK with Electron.
  </Card>
  <Card href="/v0.7.0/sdk/tutorials/expo" icon={<SiExpo className="text-[var(--color-fd-primary)]" />} title="Build an Expo app">
